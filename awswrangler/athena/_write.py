...
def to_hudi(
    ...
    """
    Insert into Athena Hudi table using INSERT INTO ... SELECT. Will create Hudi table if it does not exist.
    ...
    Examples
    --------
    Insert into an existing Hudi table
    ...
    Create Hudi table and insert data (table doesn't exist, requires table_location)
